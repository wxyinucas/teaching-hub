...
求极限 $\lim_{x\to0} \frac{\int_0^{\sin^2 x} \ln(1+t^2) dt}{x^2(e^{2x}-1)}$。
...
求极限 $\lim_{x \to 0} \frac{\int_0^{x^2} \sqrt{1+t^2} \sin t dt}{x^4}$。
...
$\lim_{x \to \infty} \frac{\int_0^{x^2} \arctan t dt}{x^2} =$（ \quad ）\\
A. 0 \quad B. 1 \quad C. $\frac{\pi}{2}$ \quad D. $\infty$
